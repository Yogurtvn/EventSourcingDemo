...
[Route("inventory")]
[Route("api/inventory")]
public sealed class InventoryEventStoreController(InventoryDbContext dbContext) : ControllerBase
{
    ...
    public async Task<IActionResult> GetInventoryEvents(Guid orderId, CancellationToken cancellationToken)
    {
        var events = await dbContext.EventStore
