...
[Route("payments")]
[Route("api/payments")]
public sealed class PaymentEventStoreController(PaymentDbContext dbContext) : ControllerBase
{
    ...
    public async Task<IActionResult> GetPaymentEvents(Guid orderId, CancellationToken cancellationToken)
    {
        var events = await dbContext.EventStore
